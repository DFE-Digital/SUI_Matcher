...
public class ProcessCsvFileResult(string outputCsvFile, string statsJsonFile, string reportPdfFile, dynamic stats, string outputDirectory)
{
    ...
    public dynamic Stats { get; set; } = stats;
}