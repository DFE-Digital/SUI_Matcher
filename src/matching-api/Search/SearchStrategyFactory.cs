...
{
    private static readonly Dictionary<string, Func<int?, ISearchStrategy>> Strategies = new(
    ...
    )
    {
        ...
        { SharedConstants.SearchStrategy.Strategies.Strategy5, v => new SearchStrategy5(v) },
    };
