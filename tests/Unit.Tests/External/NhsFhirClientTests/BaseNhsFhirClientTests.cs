...
public class BaseNhsFhirClientTests
{
            ...
            where TResource : class
        {
            var resource =
                new Patient
                {
                    ...
                    Name =
                    [
                        new HumanName("Smith", ["John"]) { Period = null },
                        new HumanName("Smith", ["John"])
                        {
                            Period = new Period { Start = "01/01/2001", End = null },
                        },
                        new HumanName("Smith", ["John"])
                        {
                            Period = new Period { Start = "01/01/2001", End = "01/01/2002" },
                        },
                    ],
                    Telecom =
                    [
                    ...
                    [
                        new Address
                        {
                            Period = new Period { Start = "2012-09-02", End = null },
                            PostalCode = "LS123EA",
                            Use = Address.AddressUse.Home,
                            Line = ["64 Higher Street", "Leeds", "West Yorkshire"],
                        },
                        new Address
                        {
                            Period = new Period { Start = "2019-12-02", End = "2024-12-01" },
                            PostalCode = "LS123EH",
                            Use = Address.AddressUse.Billing,
                            Line = ["54 Medium Street", "Leeds", "West Yorkshire"],
                        },
                        new Address
                        {
                            Period = new Period { Start = "2012-09-02", End = "2019-12-01" },
                            PostalCode = "LS123EG",
                            Use = Address.AddressUse.Work,
                            Line = ["34 Low Street", "Leeds", "West Yorkshire"],
                        },
                        new Address
                        {
                            Period = new Period { Start = "2010-09-01", End = "2012-09-01" },
                            PostalCode = "LS123EF",
                            Use = Address.AddressUse.Temp,
                            Line = ["12 High,Street", "Leeds", "West Yorkshire"],
                        },
                    ],
                    GeneralPractitioner =
                    [
    ...
    {
        public TestFhirClientMultiMatch(
            string endpoint,
            FhirClientSettings settings = null!,
            HttpMessageHandler messageHandler = null!
        )
    ...
    {
        public TestFhirClientUnmatched(
            string endpoint,
            FhirClientSettings settings = null!,
            HttpMessageHandler messageHandler = null!
        )
        ...
        throw new FhirOperationException(
            ...
            new OperationOutcome
            {
                ...
                [
                    new OperationOutcome.IssueComponent
                    {
                        Details = new CodeableConcept("FHIR", _errorCode),
                    },
                ],
            }
        );
