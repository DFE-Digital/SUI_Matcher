...
public class CsvUtilsTests
{
    ...
    public void WrapInputForCsv_ReturnsRawInput_WhenNoSpecialCharacters()
    {
        ...
        Assert.Equal(
            "home~64 Higher Street~Leeds~West Yorkshire~LS123EA| billing~54 Medium Street~Leeds~West Yorkshire~LS123EH|",
            result
        );
    }
    ...
    public void WrapInputForCsv_ReturnsWrappedInput_WhenInputContainsCommas()
    {
        ...
        [
            "home~64 Higher,Street~Leeds~West Yorkshire~LS123EA|",
            "billing~54 Medium Str,eet~Leeds~West Yorkshire~LS123EH|",
        ];

        var result = CsvUtils.WrapInputForCsv(input);

        var expectedResult =
            "\"home~64 Higher,Street~Leeds~West Yorkshire~LS123EA| billing~54 Medium Str,eet~Leeds~West Yorkshire~LS123EH|\"";
