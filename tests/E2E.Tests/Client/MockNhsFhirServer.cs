...
{
    private readonly IWireMockAdminApi _wireMockAdminApi = RestClient.For<IWireMockAdminApi>(
    ...
    {
        builder.Given(b =>
            b.WithRequest(request => request.UsingPost().WithPath("/oauth2/token"))
                .WithResponse(response =>
                    response
                        .WithHeaders(h => h.Add("Content-Type", "application/json"))
                        .WithBodyAsJson(() => new { access_token = "12312321321321" })
                )
        );

        builder.Given(b =>
            b.WithRequest(request =>
                    request
                        .UsingGet()
                ...
                .WithResponse(response =>
                    response
                        ...
                        .WithBody(() =>
                            File.ReadAllText(
                                Path.Combine("Resources", "WireMockMappings", "multi_match.json")
                            )
                        )
                )
        );
            ...
            b.WithRequest(request =>
                ...
                .WithResponse(response =>
                    response
                        ...
                        .WithBody(() =>
                            File.ReadAllText(
                                Path.Combine("Resources", "WireMockMappings", "no_match.json")
                            )
                        )
                )
        );
            ...
            b.WithRequest(request =>
                ...
                .WithResponse(response =>
                    response
                        ...
                        .WithBody(() =>
                            File.ReadAllText(
                                Path.Combine("Resources", "WireMockMappings", "single_match.json")
                            )
                        )
                )
        );
                        ...
                        .WithBody(() =>
                            File.ReadAllText(
                                Path.Combine(
                                    "Resources",
                                    "WireMockMappings",
                                    "single_match_low_confidence.json"
                                )
                            )
                        )
                )
                        ...
                        .WithBody(() =>
                            File.ReadAllText(
                                Path.Combine(
                                    "Resources",
                                    "WireMockMappings",
                                    "single_match_really_low_confidence.json"
                                )
                            )
                        )
                )
                        ...
                        .WithBody(() =>
                            File.ReadAllText(
                                Path.Combine(
                                    "Resources",
                                    "WireMockMappings",
                                    "single_match_low_confidence_9876543210.json"
                                )
                            )
                        )
                )
        ...
        builder.Given(b =>
            b.WithRequest(request =>
                    request.UsingGet().WithPath("/personal-demographics/FHIR/R4/Patient/9876543210")
                )
                .WithResponse(response =>
                    response
                        .WithHeaders(h => h.Add("Content-Type", "application/json"))
                        .WithBody(() =>
                            File.ReadAllText(
                                Path.Combine(
                                    "Resources",
                                    "WireMockMappings",
                                    "patient_low_confidence_match_9876543210.json"
                                )
                            )
                        )
                )
